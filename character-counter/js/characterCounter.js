...
function initCounter(my_counter){
    sanitizeParameters(my_counter);
            
    // If it's in a repeatable, switch to that function instead
    if( my_counter.repeatable ){
        initRepeatable(my_counter);
        return;
    }
            
    //find the right field
    var field_name = "f_" + my_counter.editable.trim();
...
function initRepeatable(my_counter) {
...
function sanitizeParameters(my_counter) {
